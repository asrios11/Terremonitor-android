...
public class UltimaHoraActivity extends AppCompatActivity implements DescargaTerremotosAPI.DownloadTerremotosInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ultima_hora);

        terremotoListView = (ListView) findViewById(R.id.lista_terremoto_view1);
        ...
        try{
            downloadTerremoto.execute(new URL("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_hour.geojson"));
    ...
    public void onTerremotosDownloaded(ArrayList<Terremoto> eqList) {
        ...
        terremotoListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent intent = new Intent(UltimaHoraActivity.this, DetallesActivity.class);
